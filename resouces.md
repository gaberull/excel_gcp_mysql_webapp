...
- [Retreive cell by column and row - PhpSpreadsheet](https://phpspreadsheet.readthedocs.io/en/latest/topics/accessing-cells/#retrieving-a-cell-value-by-column-and-row)
- [Remove excess whitespace inside str PHP - Stack Overflow](https://stackoverflow.com/questions/1703320/remove-excess-whitespace-from-within-a-string)
